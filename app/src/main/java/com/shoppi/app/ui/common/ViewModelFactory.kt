...
import com.shoppi.app.network.ServiceLocator
...
import com.shoppi.app.ui.categordetail.CategoryDetailViewModel
import com.shoppi.app.ui.category.CategoryViewModel
import com.shoppi.app.ui.home.HomeViewModel
import com.shoppi.app.ui.productdeatil.ProductDetailViewModel
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(ProductDetailViewModel::class.java) -> {
                ...
                throw IllegalArgumentException("Failed to ceate ViewModel : ${modelClass.name}")
            }
        }
    }
}